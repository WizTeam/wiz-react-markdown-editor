...
const EVENT_KEYS = (0, _utils.generateKeyHash)([
  'Enter',
  'Backspace',
  'Space',
  'Delete',
...
const LOWERCASE_TAGS = (0, _utils.generateKeyHash)([
  ...blockContainerElementNames,
  ...emptyElementNames,
  'div'
]);
exports.LOWERCASE_TAGS = LOWERCASE_TAGS;
const CLASS_OR_ID = (0, _utils.genUpper2LowerKeyHash)([
  'AG_ACTIVE',
  'AG_AUTO_LINK',
...
const DAED_REMOVE_SELECTOR = new Set([
...
const isWin =
  ...
  /win32|wow32|win64|wow64/i.test(window.navigator.userAgent); // http[s] (domain or IPv4 or localhost or IPv6) [port] /not-white-space
