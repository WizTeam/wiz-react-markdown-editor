...
Diagram.Note.prototype.hasManyActors = function () {
  return _underscore.default.isArray(this.actor);
};
...
function ParseError(message, hash) {
  _underscore.default.extend(this, hash);
...
function wobble(x1, y1, x2, y2) {
  assert(_underscore.default.all([x1, x2, y1, y2], _underscore.default.isFinite), 'x1,x2,y1,y2 must be numeric'); // Wobble no more than 1/25 of the line length
...
function handRect(x, y, w, h) {
  assert(_underscore.default.all([x, y, w, h], _underscore.default.isFinite), 'x, y, w, h must be numeric');
...
function handLine(x1, y1, x2, y2) {
  assert(_underscore.default.all([x1, x2, y1, y2], _underscore.default.isFinite), 'x1,x2,y1,y2 must be numeric');
...
_underscore.default.extend(BaseTheme.prototype, {
  ...
  layout: function () {
    ...
    _underscore.default.each(actors, function (a) {
    ...
    _underscore.default.each(signals, function (s) {
      // Indexes of the left and right actors involved
      var a;
      var b;
      var bb = this.textBBox(s.message, font); //var bb = t.attr("text", s.message).getBBox();
    ...
    _underscore.default.each(actors, function (a) {
      ...
      _underscore.default.each(a.distances, function (distance, b) {
  ...
  drawActors: function (offsetY) {
    ...
    _underscore.default.each(this.diagram.actors, function (a) {
      // Top box
  ...
  drawSignals: function (offsetY) {
    ...
    _underscore.default.each(this.diagram.signals, function (s) {
...
if (typeof _snap.default != 'undefined') {
  ...
  _underscore.default.extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    waitForFont: function (callback) {
      ...
      if (typeof _webfontloader.default == 'undefined') {
    ...
    createText: function (text, font) {
      text = _underscore.default.invoke(text.split('\n'), 'trim');
  ...
  _underscore.default.extend(SnapHandTheme.prototype, SnapTheme.prototype, {
    drawLine: function (x1, y1, x2, y2, linetype, arrowhead) {
...
if (_underscore.default.isEmpty(Diagram.themes)) {
...
Diagram.prototype.drawSVG = function (container, options) {
  ...
  options = _underscore.default.defaults(options || {}, defaultOptions);
  ...
  var div = _underscore.default.isString(container) ? document.getElementById(container) : container;
