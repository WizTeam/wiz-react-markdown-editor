...
class FrontMenu extends _baseFloat.default {
  ...
  renderSubMenu(subMenu) {
    ...
    const children = subMenu.map(menuItem => {
      ...
      const iconWrapper = (0, _snabbdom.h)(iconWrapperSelector, (0, _snabbdom.h)('i.icon', (0, _snabbdom.h)("i.icon-".concat(label.replace(/\s/g, '-')), {
        style: {
  ...
  selectItem(event, {
    ...
    const {
      type,
      functionType
    } = this.outmostBlock; // front matter can not be duplicated.
