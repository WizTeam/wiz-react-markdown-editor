...
function autoLink(h, cursor, block, token, outerClass) {
  ...
  return [h("span.".concat(className), startMarker), h("a.".concat(_config.CLASS_OR_ID.AG_INLINE_RULE, ".").concat(_config.CLASS_OR_ID.AG_AUTO_LINK), {
    attrs: {
      spellcheck: 'false'
    },
    props: {
  ...
  }, content), h("span.".concat(className), endMarker)];
}