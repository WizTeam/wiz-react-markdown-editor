...
var _default = {
  ...
  backlash: _backlash.default,
  highlight: _highlight.default,
  header: _header.default,
  link: _link.default,
  htmlTag: _htmlTag.default,
  hr: _hr.default,
  tailHeader: _tailHeader.default,
  hardLineBreak: _hardLineBreak.default,
  softLineBreak: _softLineBreak.default,
  codeFense: _codeFense.default,
  inlineMath: _inlineMath.default,
  autoLink: _autoLink.default,
  autoLinkExtension: _autoLinkExtension.default,
  loadImageAsync: _loadImageAsync.default,
  image: _image.default,
  delEmStrongFac: _delEmStringFactory.default,
  ...
  multipleMath: _multipleMath.default,
  referenceDefinition: _referenceDefinition.default,
  htmlRuby: _htmlRuby.default,
  referenceLink: _referenceLink.default,
  referenceImage: _referenceImage.default,
  superSubScript: _superSubScript.default,
  footnoteIdentifier: _footnoteIdentifier.default,
  tag: _tag.default
};
