...
block._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/;
block._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/;
block.def = (0, _utils.edit)(block.def)
...
block.list = (0, _utils.edit)(block.list)
...
block._tag =
  ...
  '|track|ul';
block._comment = /<!--(?!-?>)[\s\S]*?-->/;
block.html = (0, _utils.edit)(block.html, 'i')
  .replace('comment', block._comment)
  .replace('tag', block._tag)
  .replace('attribute', / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/)
  .getRegex();
block.paragraph = (0, _utils.edit)(block._paragraph)
  .replace('hr', block.hr)
  ...
  .getRegex();
block.blockquote = (0, _utils.edit)(block.blockquote)
...
const pedantic = Object.assign({}, normal, {
  ...
  paragraph: (0, _utils.edit)(normal._paragraph)
    .replace('hr', block.hr)
    .replace('heading', ' *#{1,6} *[^\n]')
