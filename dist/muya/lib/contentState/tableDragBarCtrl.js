...
exports.getAllTableCells = getAllTableCells;
...
const tableDragBarCtrl = (ContentState) => {
  ContentState.prototype.handleMouseDown = function (event) {
    ...
    if ('ontouchmove' in window.document) {
      moveType = 'touchmove';
      upType = 'touchend';
    } else if ('onmousemove' in window.document) {
      moveType = 'mousemove';
      upType = 'mouseup';
    } //
  ...
  ContentState.prototype.handleMouseUp = function (event) {
    ...
    this.setDropTargetStyle(); // The drop animation need 300ms.
